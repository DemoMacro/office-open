      ...
      children: [
        ...
        new Shape({
          ...
          paragraphs: [
            ...
            new Paragraph({
              children: [new TextRun({ text: "No proof text", noProof: true, fontSize: 16 })],
            }),
            new Paragraph({
              children: [new TextRun({ text: "Shadow text", shadow: true, fontSize: 16 })],
            }),
            new Paragraph({
              children: [new TextRun({ text: "Outline text", outline: true, fontSize: 16 })],
            }),
          ],
        }),
        // Line spacing demo
