...
generatePresentation({
  size: { width: "33.9cm", height: "19.1cm" }, // EMU number or UniversalMeasure
  slides: [
    {
      children: [
        {
...
generatePresentation({
  slides: [
    {
      layout: "title", // or "blank", "object", "sectionHeader", etc.
      children: [],
    },
  ],
});
...
| `"title"`                | Title Slide             |
| `"text"`                 | Title and Text          |
| `"twoColumnText"`        | Two Content             |
| `"titleOnly"`            | Title Only              |
| `"object"`               | Title and Content       |
| `"sectionHeader"`        | Section Header          |
| `"chart"`                | Chart                   |
| `"table"`                | Table                   |
| `"clipArtAndText"`       | Clip Art and Text       |
| `"pictureText"`          | Picture with Caption    |
| `"twoObjects"`           | Two Content             |
| `"twoTextAndTwoObjects"` | Comparison              |
| `"objectAndText"`        | Content with Caption    |
...
| Property    | Description                                                                             |
| ----------- | --------------------------------------------------------------------------------------- |
| `majorFont` | Heading font — `FontCollectionOptions` (`latin`, `eastAsia`, `complexScript`, `symbol`) |
| `minorFont` | Body font — `FontCollectionOptions` (`latin`, `eastAsia`, `complexScript`, `symbol`)    |
