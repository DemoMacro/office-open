/**
 * Drawing descriptor for XLSX — generates xl/drawings/drawing{n}.xml.
 *
 * Uses the spreadsheetDrawing namespace for anchoring images and charts to
 * worksheet cells. Follows PPTX slideDesc pattern: CustomDescriptor with
 * manual parts.push/join XML building.
 *
 * @module
 */
