...
import { patchDocument } from "docx-plus";
...
[Example](https://raw.githubusercontent.com/DemoMacro/docx-plus/main/demo/85-template-document.ts ":include :type=code typescript")
