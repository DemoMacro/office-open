...
Each comment reuses the `CommentOptions` vocabulary (see [Comments and Revisions](./15.comments-and-revisions)) but omits the `id` — the patch assigns continuation ids automatically.
