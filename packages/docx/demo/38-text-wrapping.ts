...
const imageData = readFileSync("./demo/images/pizza.gif");
...
const buffer = await generateDocument({
  sections: [
    ...
    // 4. TOP_AND_BOTTOM — Text appears only above and below the image
    {
      properties: {},
      children: [
        { paragraph: "TOP_AND_BOTTOM wrapping:" },
        {
          paragraph: {
            children: [
              {
    ...
    // 5. NONE — In front of text (behindDocument: false, default)
    {
      properties: {},
      children: [
        { paragraph: "NONE wrapping (in front of text):" },
        {
          paragraph: {
            children: [
              {
    ...
    // 6. NONE — Behind text (behindDocument: true)
    {
      properties: {},
      children: [
        { paragraph: "NONE wrapping (behind text):" },
        {
          paragraph: {
            children: [
              {
