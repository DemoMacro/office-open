...
The `Packer` class supports multiple output formats. Every async method has a synchronous counterpart (e.g., `toBufferSync`). See the [Export](./11.export) page for the full list.
