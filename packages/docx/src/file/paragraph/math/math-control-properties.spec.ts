...
describe("createMathControlProperties", () => {
  ...
  it("should create control properties with insertionReference", () => {
    const tree = new Formatter().format(createMathControlProperties({ insertionReference: "123" }));
  ...
  it("should create control properties with deletionReference", () => {
    const tree = new Formatter().format(createMathControlProperties({ deletionReference: "456" }));
    expect(tree).to.deep.equal({
