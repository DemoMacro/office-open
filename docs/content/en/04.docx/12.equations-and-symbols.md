...
| `alignment`    | `"center" \| "distributeLetter" \| "distributeSpace" \| "left" \| "right" \| "rightVertical"` | Alignment (default: `"center"`)       |
| `fontSize`     | `number`                                                                                      | Ruby text font size in points         |
| `raise`        | `number`                                                                                      | Vertical offset in points             |
| `baseFontSize` | `number`                                                                                      | Base text font size in points         |
| `languageId`   | `string`                                                                                      | Language identifier (e.g., `"ja-JP"`) |
| `dirty`        | `boolean`                                                                                     | Whether the annotation is dirty       |
