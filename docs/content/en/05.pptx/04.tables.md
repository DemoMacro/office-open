...
| `vert`          | `"horizontal" \| "vertical" \| "vertical270" \| "wordArtVertical" \| "wordArtVerticalRightToLeft"` | Text direction within the cell (a:tcPr @vert) |
...
| `dash`   | `"solid" \| "dash" \| "dashDot" \| "longDash" \| ...` | Dash style   |
