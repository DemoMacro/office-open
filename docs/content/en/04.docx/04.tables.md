                ...
                "cells": [
                  {
                    ...
                    "width": { "size": 3000, "type": "twips" }
                  },
                  {
                    "children": [{ "paragraph": { "children": ["Col 2"] } }],
                    "width": { "size": 2000, "type": "twips" }
                  },
                  {
  ...
  sections: [
    {
      children: [
        {
          table: {
            width: { size: 100, type: "percent" }, // 100% of page width
            rows: [
              {
                cells: [{ children: [{ paragraph: { children: ["Full width table"] } }] }],
              },
...
- `"twips"` — Fixed width in twips
- `"percent"` — Percentage of page width (100 = 100%)
