...
| `vertical`      | `"horizontal" \| "vertical" \| "vertical270" \| "wordArtVertical" \| "eastAsianVertical" \| "mongolianVertical" \| "wordArtVerticalRightToLeft"` | Text direction within the cell (a:tcPr @vert) |
...
| `dashStyle` | `"solid" \| "dot" \| "dash" \| "lgDash" \| "dashDot" \| "lgDashDot" \| "lgDashDotDot" \| "sysDash" \| "sysDot" \| "sysDashDot" \| "sysDashDotDash"` | Dash style   |
