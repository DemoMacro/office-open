...
describe("createMathProperties", () => {
  ...
  it("should create math properties with defaultJustification", () => {
    const tree = new Formatter().format(createMathProperties({ defaultJustification: "center" }));
    expect(tree).to.deep.equal({
  ...
  it("should create math properties with wrapIndent and wrapRight", () => {
    const tree = new Formatter().format(createMathProperties({ wrapIndent: 500, wrapRight: true }));
    expect(tree).to.deep.equal({
