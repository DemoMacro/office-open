...
See [Patching](./12.patch) for full documentation.
...
See [Parsing](./11.parsing) for full documentation.

## Export Formats

Every async method has a synchronous counterpart (e.g., `toBufferSync`). See the [Export](./10.export) page for the full list.
