  ...
  sections: [
    {
      children: [
        ...
        new Paragraph({
          children: [new TextRun({ bold: true, text: "Table 2: Inserted  Table Column" })],
        }),
        new Table({
          columnWidths: [2000, 2000],
          layout: "fixed",
        ...
        new Paragraph({
          children: [new TextRun({ bold: true, text: "Table 3: cell properties revision" })],
        }),
        new Table({
          columnWidths: [2000, 2000],
          rows: [
        ...
        new Paragraph({
          children: [new TextRun({ bold: true, text: "Table 4: row properties revision" })],
        }),
        new Table({
          columnWidths: [2000, 2000],
          layout: "fixed",
