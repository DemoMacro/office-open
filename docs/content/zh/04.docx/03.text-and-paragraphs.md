...
| `textDirection`    | `"lr" \| "rl" \| "tb" \| "tbV" \| "rlV" \| "lrV"`                                 | 文本流向（w:textDirection ST_TextDirection）                                                             |
| `textboxTightWrap` | `"none" \| "allLines" \| "firstAndLastLine" \| "firstLineOnly" \| "lastLineOnly"` | 文本框内紧密环绕（w:textboxTightWrap）                                                                   |
| `divId`            | `number`                                                                          | HTML div id 引用（w:divId）                                                                              |
| `cnfStyle`         | `object`                                                                          | 表格行/单元格条件格式标志（w:cnfStyle — firstRow/lastRow/firstColumn/lastColumn/...）                    |
...
| `verticalAlign` | `string` | 下标 / 上标 / 基线（"subscript" | "superscript" | "baseline"） |
