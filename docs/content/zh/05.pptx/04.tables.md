...
| `vertical`      | `"horizontal" \| "vertical" \| "vertical270" \| "wordArtVertical" \| "eastAsianVertical" \| "mongolianVertical" \| "wordArtVerticalRightToLeft"` | 单元格内文本方向（a:tcPr @vert） |
...
| `color`     | `string`                                                                                                                                            | 十六进制颜色 |
| `dashStyle` | `"solid" \| "dot" \| "dash" \| "lgDash" \| "dashDot" \| "lgDashDot" \| "lgDashDotDot" \| "sysDash" \| "sysDot" \| "sysDashDot" \| "sysDashDotDash"` | 虚线样式     |
