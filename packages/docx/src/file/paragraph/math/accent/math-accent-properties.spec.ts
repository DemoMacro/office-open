...
describe("createMathAccentProperties", () => {
  it("should create accent properties with accentCharacter", () => {
    const tree = new Formatter().format(createMathAccentProperties({ accentCharacter: "\u0302" }));
  ...
  it("should create accent properties with tilde character", () => {
    const tree = new Formatter().format(createMathAccentProperties({ accentCharacter: "\u0303" }));
    expect(tree).to.deep.equal({
