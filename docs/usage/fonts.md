...
import { CharacterSet, Document, Paragraph, TextRun } from "@office-open/docx";
...
```ts
import { CharacterSet, Document, Packer, Paragraph, TextRun } from "@office-open/docx";
...
[Example](https://raw.githubusercontent.com/DemoMacro/office-open/main/packages/docx/demo/91-custom-fonts.ts ":include")

_Source: https://github.com/DemoMacro/office-open/blob/main/packages/docx/demo/91-custom-fonts.ts_

### Declarative Custom Fonts

[Example](https://raw.githubusercontent.com/DemoMacro/office-open/main/packages/docx/demo/92-declarative-custom-fonts.ts ":include")

_Source: https://github.com/DemoMacro/office-open/blob/main/packages/docx/demo/92-declarative-custom-fonts.ts_
