    ...
    slides: [
        {
            children: [
                ...
                new Shape({
                    ...
                    effects: {
                        outerShadow: { blur: 50800, dist: 38100, direction: 5400000, color: "000000", alpha: 50 },
                    },
                }),
                new Shape({
                    x: 300,
                ...
                new Shape({
                    ...
                    effects: {
                        reflection: { blurRadius: 6350, dist: 38100, direction: 5400000, fadeStart: 90, fadeEnd: 0 },
                    },
                }),
                new Shape({
                    x: 50,
                    ...
                    effects: {
                        innerShadow: { blur: 40000, dist: 30000, direction: 5400000, color: "000000", alpha: 40 },
                    },
                }),
                new Shape({
                    x: 300,
                ...
                new Shape({
                    ...
                    effects: {
                        outerShadow: { blur: 40000, dist: 30000, direction: 2700000, color: "000000", alpha: 40 },
