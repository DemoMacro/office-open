...
| `picture`                                            | Embedded images with transformation and positioning    |
...
| `formField`                                          | Form fields — checkbox, dropdown, text input           |
...
Every async function has a synchronous counterpart (e.g., `generateDocumentSync`). See the [Export](./export) page for the full list.
