...
| `settings.view`, `settings.zoom`, `settings.defaultTabStop` | `word/settings.xml`   | Document settings                                        |
| `settings.evenAndOddHeaders`                                | `word/settings.xml`   | Header/footer mode                                       |
| `settings.trackRevisions`                                   | `word/settings.xml`   | Track changes                                            |
| `settings.updateFields`                                     | `word/settings.xml`   | Auto-update fields                                       |
| `background`                                                | `word/settings.xml`   | Document background                                      |
| `settings.docVars`                                          | `word/settings.xml`   | Document variables                                       |
...
| ------------------- | -------- | ----------------------------------------------------------- |
| `commentRangeStart` | `object` | Start of a comment range (`id`, `displacedByCustomXml?`)    |
| `commentRangeEnd`   | `object` | End of a comment range (`id`, `displacedByCustomXml?`)      |
...
| `bookmarkEnd`       | `object` | Bookmark end (`id`, `displacedByCustomXml?`)                |
| `picture`           | `object` | Embedded picture, contains `type`, `data`, `transformation` |
