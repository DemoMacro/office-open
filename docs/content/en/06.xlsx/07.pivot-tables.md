...
| Count Numbers        | `"countNumbers"`                | Count of numbers        |
| Max                  | `"max"`                         | Maximum value           |
| Min                  | `"min"`                         | Minimum value           |
| Product              | `"product"`                     | Product of values       |
| StdDev (sample)      | `"standardDeviation"`           | STDEV.S                 |
| StdDevP (population) | `"standardDeviationPopulation"` | STDEV.P                 |
| Var (sample)         | `"var"`                         | VAR.S                   |
| VarP (population)    | `"variancePopulation"`          | VAR.P                   |
