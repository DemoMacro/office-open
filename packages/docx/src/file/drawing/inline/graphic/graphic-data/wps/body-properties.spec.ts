...
describe("BodyProperties", () => {
  describe("#constructor()", () => {
    ...
    it("should create with direct anchor property", () => {
      const tree = new Formatter().format(createBodyProperties({ anchor: VerticalAnchor.JUSTIFY }));
    ...
    it("should create with column settings", () => {
      const tree = new Formatter().format(createBodyProperties({ numCol: 3, spcCol: 100000 }));
    ...
    it("should create with normAutofit", () => {
      ...
      expect(tree).to.deep.equal({
        "wps:bodyPr": [{ "a:normAutofit": { _attr: { fontScale: 80000, lnSpcReduction: 10000 } } }],
      });
    });
