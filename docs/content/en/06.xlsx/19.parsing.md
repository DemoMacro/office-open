...
| `revisionLog`    | `xl/revisionHeaders.xml` | Shared-workbook revision history (see [Revisions](/en/xlsx/revisions)) |
...
| `customProps`   | `string \| undefined`  | Path to custom properties (`docProps/custom.xml`) |
