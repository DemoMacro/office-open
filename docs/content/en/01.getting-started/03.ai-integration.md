...
Configure the remote MCP server URL `https://office-open.com/mcp` in your client's MCP settings. The server provides a `search` tool for querying documentation content.
...
```bash
npx skills add https://office-open.com
```
...
```
https://office-open.com/.well-known/skills/office-open/SKILL.md
```
...
- https://office-open.com/llms.txt
```
