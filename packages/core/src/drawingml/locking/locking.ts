...
export function createShapeLocking(opts: ShapeLockingOptions): string {
  return element("a:spLocks", toFlatAttrs(opts as Record<string, boolean | undefined>));
}

export function createPictureLocking(opts: PictureLockingOptions): string {
  return element("a:picLocks", toFlatAttrs(opts as Record<string, boolean | undefined>));
}

export function createGroupLocking(opts: GroupLockingOptions): string {
  return element("a:grpSpLocks", toFlatAttrs(opts as Record<string, boolean | undefined>));
}
