...
describe("Comment", () => {
  ...
  describe("#constructor()", () => {
    it("should create", () => {
      ...
      expect(tree).to.deep.equal({
        "w:comment": [
          { _attr: { "w:date": "1999-01-01T00:00:00.000Z", "w:id": 0 } },
          {
            "w:p": [
              {
                "w:r": [
    ...
    it("should create", () => {
      ...
      expect(tree).to.deep.equal({
        "w:comments": [
                ...
                "w:p": [
                  {
                    "w:r": [
                      {
                        "w:t": [{ _attr: { "xml:space": "preserve" } }, "test-comment"],
                      },
                    ],
                  },
                ],
          ...
          {
            "w:comment": [
              { _attr: { "w:date": "1999-01-01T00:00:00.000Z", "w:id": 1 } },
              {
                "w:p": [
                  {
                    "w:r": [
                      {
                        "w:t": [{ _attr: { "xml:space": "preserve" } }, "test-comment-2"],
                      },
                    ],
                  },
                ],
