...
| `series`     | `ChartSeriesData[] \| ScatterSeriesData[]` | Series data                   |
...
Scatter charts use `ScatterSeriesData` — XY numeric axes without bubble sizes:
...
Bubble charts extend it with `BubbleSeriesData`:
