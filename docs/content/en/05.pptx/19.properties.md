...
```json [JSON]
{
  ...
  "slides": [
    {
      "children": [
        { "shape": { "textBody": { "paragraphs": ["Presentation with custom settings"] } } }
      ]
    }
  ]
}
...
generatePresentation({
  ...
  slides: [
    {
      children: [{ shape: { textBody: { paragraphs: ["Presentation with custom settings"] } } }],
    },
  ],
});
```
...
```json [JSON]
{
  ...
  "slides": [
    {
      "children": [{ "shape": { "textBody": { "paragraphs": ["Protected presentation"] } } }]
    }
  ]
}
```
...
```json [JSON]
{
  ...
  "slides": [
    {
      "children": [{ "shape": { "textBody": { "paragraphs": ["Slide with view settings"] } } }]
    }
  ]
}
```
...
```json [JSON]
{
  ...
  "slides": [
    {
      "children": [{ "shape": { "textBody": { "paragraphs": ["Full presentation properties"] } } }]
    }
  ]
}
```
...
```json [JSON]
{
  ...
  "slides": [
    {
      "children": [{ "shape": { "textBody": { "paragraphs": ["HTML publish demo"] } } }]
    }
  ]
}
```
...
```json [JSON]
{
  ...
  "slides": [
    {
      "children": [{ "shape": { "textBody": { "paragraphs": ["Photo Album"] } } }]
    }
  ]
}
```
