...
```ts [Class]
import {
  Paragraph, Math: MathAPI, MathRun, MathSum, MathSuperScript,
  ...
  children: [
    new MathAPI({
      children: [
        ...
        new MathRun("="),
        new MathSum({
          children: [new MathSuperScript({ children: [new MathRun("x")], superScript: [new MathRun("2")] })],
...
new MathSquareBrackets({ children: [new MathRun("x")] });
new MathCurlyBrackets({ children: [new MathRun("a"), new MathRun("b")] });
new MathAngledBrackets({ children: [new MathRun("x")] });
```
