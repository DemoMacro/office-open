...
Each comment reuses the `CommentOptions` vocabulary (see [Comments and Revisions](./comments-and-revisions)) but omits the `id` — the patch assigns continuation ids automatically.
