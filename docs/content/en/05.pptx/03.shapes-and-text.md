...
[
  {
    shape: {
      properties: { geometry: "ellipse", fill: "4472C4", outline: { color: "2E74B5", width: 2 } },
    },
  },
  {
    shape: {
      properties: { geometry: "triangle", fill: "ED7D31", outline: { color: "C5504B", width: 2 } },
    },
  },
];
```
...
`outline` and `shadow` accept `true` for a sensible default or a full options object — see [Outline](./effects-and-fills#outline) and [Effects](./effects-and-fills#effects) for the complete shapes. See [Links](./links) for `hyperlink` (external `url` or internal `slide` jump).
