/**
 * Text list style (CT_TextListStyle) descriptor for PPTX.
 *
 ...
 * reproduces the prior verbatim block bit-for-bit (the 16-round-trip fidelity
 * gate depends on it). Parse is the inverse, giving a structured, editable form
...
// ── Descriptor (element-tag-agnostic; caller wraps per part) ──
