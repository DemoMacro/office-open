...
describe("SectionProperties", () => {
  describe("#constructor()", () => {
    ...
    it("should create section properties with noEndnote", () => {
      ...
      const tree = new Formatter().format(properties);
      const noEndnote = tree["w:sectPr"].find((item: any) => item["w:noEndnote"] !== undefined);
    ...
    it("should create section properties with rtlGutter", () => {
      ...
      const tree = new Formatter().format(properties);
      const rtlGutter = tree["w:sectPr"].find((item: any) => item["w:rtlGutter"] !== undefined);
    ...
    it("should create section properties with footnotePr", () => {
      ...
      const tree = new Formatter().format(properties);
      const footnotePr = tree["w:sectPr"].find((item: any) => item["w:footnotePr"] !== undefined);
    ...
    it("should create section properties with endnotePr", () => {
      ...
      const tree = new Formatter().format(properties);
      const endnotePr = tree["w:sectPr"].find((item: any) => item["w:endnotePr"] !== undefined);
