  ...
  public override toXml(_context: Context): string {
    ...
    for (const img of this.images) {
      p.push(
        ...
        `<blipFill><a:blip r:embed="${img.rId}"/><a:stretch><a:fillRect></a:fillRect></a:stretch></blipFill>`,
        `<spPr><a:xfrm><a:off x="0" y="0"/><a:ext cx="400000" cy="300000"/></a:xfrm><a:prstGeom prst="rect"><a:avLst></a:avLst></a:prstGeom></spPr></pic>`,
        `<clientData></clientData></twoCellAnchor>`,
      );
      id++;
    }
    for (const chart of this.charts) {
      p.push(
        ...
        `<graphicFrame><nvGraphicFramePr><cNvPr id="${id}" name="Chart ${id}"/><cNvGraphicFramePr><a:graphicFrameLocks noGrp="1"></a:graphicFrameLocks></cNvGraphicFramePr></nvGraphicFramePr>`,
