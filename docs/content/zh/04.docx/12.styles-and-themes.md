    ...
    "paragraphStyles": [
      {
        ...
        "name": "My Heading",
        "basedOn": "Heading1",
        "run": { "font": "Arial", "size": 36, "color": "2E74B5" }
      },
      {
        "id": "CodeInline",
        "name": "Code Inline",
        "run": { "font": "Consolas", "size": 20, "shading": { "fill": "F2F2F2" } }
      }
    ]
  },
  "sections": [
...
```json [JSON]
{
  ...
  "sections": [
    {
      "children": [{ "paragraph": { "children": ["Document with custom default styles."] } }]
    }
  ]
}
```
...
new Document({
  ...
  sections: [
    {
      children: [new Paragraph("Document with custom default styles.")],
    },
  ],
});
```
