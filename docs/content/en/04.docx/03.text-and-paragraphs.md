...
| `textDirection`    | `"lr" \| "rl" \| "tb" \| "tbV" \| "rlV" \| "lrV"`                                 | Text flow direction (w:textDirection ST_TextDirection)                                                         |
| `textboxTightWrap` | `"none" \| "allLines" \| "firstAndLastLine" \| "firstLineOnly" \| "lastLineOnly"` | Tight wrapping within a text box (w:textboxTightWrap)                                                          |
| `divId`            | `number`                                                                          | HTML div id reference (w:divId)                                                                                |
| `cnfStyle`         | `object`                                                                          | Conditional formatting flags for table rows/cells (w:cnfStyle — firstRow/lastRow/firstColumn/lastColumn/...)   |
...
| `verticalAlign` | `string` | Subscript / superscript / baseline ("subscript" | "superscript" | "baseline") |
