...
See [demo/45-highlighting-text.ts](https://github.com/DemoMacro/office-open/blob/main/packages/docx/demo/45-highlighting-text.ts) for highlighting examples, and [demo/46-shading-text.ts](https://github.com/DemoMacro/office-open/blob/main/packages/docx/demo/46-shading-text.ts) for shading examples.
