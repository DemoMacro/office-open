...
[Example](https://raw.githubusercontent.com/DemoMacro/docx-plus/main/demo/2-declarative-styles.ts ":include")

_Source: https://github.com/DemoMacro/docx-plus/blob/master/demo/2-declarative-styles.ts_
