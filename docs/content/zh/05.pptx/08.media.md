...
`data` 和 `poster` 字段接受原始字节（`Uint8Array`、`ArrayBuffer`、`Buffer`），也支持 base64 [data URL](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URIs)（如 `data:image/png;base64,...`）。
