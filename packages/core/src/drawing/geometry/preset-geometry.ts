...
/**
 * Preset shape tokens (a:prstGeom `@prst`, ST_ShapeType — dml-main.xsd, 188
 * values verbatim). `textNoShape` is a text-body-only preset; the arrows,
 * flowChart*, and actionButton* families round out the set.
 */
