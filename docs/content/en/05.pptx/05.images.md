...
| `name`        | `string`                                             | cNvPr display name                            |
| `description` | `string`                                             | cNvPr description (accessibility alt text)    |
| `title`       | `string`                                             | cNvPr title                                   |
| `hidden`      | `boolean`                                            | Whether the picture is hidden (default false) |
