...
Trigger audio/video playback on a media shape with `mediaType`:
...
| ----------------- | ---------------------------- | ----------------------------------------- |
| `mediaType`       | `"playAudio" \| "playVideo"` | Media animation type                      |
...
| `rotationAngle`        | `number`                          | —           | Motion path rotation (60000ths of a degree) |
