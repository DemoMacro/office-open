            ...
            "children": [
              {
                "picture": {
                  ...
                  "sourceRectangle": { "left": 1000, "top": 1000, "right": 1000, "bottom": 1000 }
                }
              }
            ]
          }
            ...
            children: [
              {
                picture: {
                  ...
                  transformation: { width: "5.3cm", height: "5.3cm" },
                  sourceRectangle: {
                    left: 1000, // Crop from left (ST_Percentage; 1000 = 1%)
                    top: 1000, // Crop from top (ST_Percentage; 1000 = 1%)
                    right: 1000, // Crop from right (ST_Percentage; 1000 = 1%)
                    bottom: 1000, // Crop from bottom (ST_Percentage; 1000 = 1%)
                  },
                },
              },
            ],
