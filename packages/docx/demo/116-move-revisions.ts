  ...
  sections: [
    {
      children: [
        ...
        new Paragraph({
          children: [new TextRun({ bold: true, text: "2. Move with Formatting", size: 28 })],
          spacing: { after: 200 },
        }),
        new Paragraph({
          children: [
        ...
        new Paragraph({
          children: [new TextRun({ bold: true, text: "3. Move Range Markers", size: 28 })],
          spacing: { after: 200 },
        }),
        new Paragraph({
          children: [
            new TextRun("This paragraph contains "),
            new MoveFromRangeStart(4, "moved-paragraph", REVISION_AUTHOR, REVISION_DATE),
